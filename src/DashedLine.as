...
package  {
	...
	public class DashedLine extends Sprite {
		...
		public function DashedLine(weight:Number = 0, color:Number = 0, lengthsArray:Array = null){
			...
			addEventListener(MouseEvent.MOUSE_OVER, function():void{Log.setText = "Press middle mouse to delete a link - ";  EventManager.dispatchEvent(new Event('updateLog'))});
		}
